...
class StreetsControllerTest < ActionController::TestCase
  ...
  test "should create street" do
    assert_difference('Street.count') do
      post :create, street: { city_id: @street.city_id, latitude: @street.latitude, longitude: @street.longitude, name: @street.name }
    end
  ...
  test "should update street" do
    patch :update, id: @street, street: { city_id: @street.city_id, latitude: @street.latitude, longitude: @street.longitude, name: @street.name }
    assert_redirected_to street_path(assigns(:street))
  end
